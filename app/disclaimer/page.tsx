    ...
    <div className="flex min-h-screen flex-col bg-gray-50 text-gray-900">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-12 md:px-10 md:py-16">
        ...
        <div className="mt-10 leading-relaxed text-gray-700">
          ...
          {/* 第1条 */}
          <h2 className="mt-10 border-b border-gray-200 pb-2 text-lg font-bold text-gray-900">
          ...
          {/* 附則 */}
          <p className="mt-12 text-right text-sm text-gray-500">
            （附則） 2026年2月19日作成・適用
          </p>
      ...
      <footer className="mt-auto border-t border-gray-100 bg-white py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 md:flex-row md:px-8">
          <nav className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <Link href="/disclaimer" className="font-medium text-blue-600">
              免責事項
            </Link>
          </nav>
